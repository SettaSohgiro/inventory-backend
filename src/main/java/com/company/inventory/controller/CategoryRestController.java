...
// 7.- se inyecta la dependencia con autowired
	...
	public ResponseEntity<CategoryResponseRest> update(@RequestBody Category category , @PathVariable Long id ){ // @PathVariable path variable sirve para recuperar la variable que se envia por la uri
	...
	public ResponseEntity<CategoryResponseRest> delete(@PathVariable Long id ){ // @PathVariable path variable sirve para recuperar la variable que se envia por la uri
		
		 ResponseEntity<CategoryResponseRest> response = service.deleteByIb( id);
		 return response;
